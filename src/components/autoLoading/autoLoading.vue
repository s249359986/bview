		...
		<section class="inner" :style="{ transform: 'translate3d(0, ' + top + 'px, 0)' }">
			<header class="pull-refresh">
				<slot name="pull-refresh">
					...
					<span class="refresh-tip">努力加载中</span>
				</slot>
			</header>
			<slot>
			</slot>
			<footer class="load-more">
				<slot name="load-more">
					...
					<span v-show="downFlag === true">努力加载中</span>
				</slot>
			</footer>
...
<script>
	export default {
		...
		methods: {
			...
			//	this.dataList.noFlag = false;//注释掉
			...
			touchMove(e) {
				...
				let diff = e.targetTouches[0].pageY - this.startY - this.startScroll//滑动的距离
				// console.log('startScroll'+this.startScroll)
				// console.log('startY'+this.startY)//相对于视口的鼠标开始的垂直坐标
				// console.log('diff'+diff)
				// console.log('pageY'+e.targetTouches[0].pageY )//相对于视口的点的垂直坐标
